...
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            ...
            <input name="username" placeholder='用户名' maxlength="16" type='text' autocomplete="off" id="username"/>
        ...
        <div class='login_fields__password'>
            <div class='icon'>
                <img alt="" src='${path}/img/lock_icon_copy.png'>
            </div>
...
<link href="${path}/plugins/layui/css/layui.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src='${path}/js/stopExecutionOnTimeout.js?t=1'></script>
<script type="text/javascript" src="${path}/plugins/layui/layui.js"></script>
<script type="text/javascript" src="${path}/js/Particleground.js"></script>
<script type="text/javascript" src="${path}/js/Treatment.js"></script>
<script type="text/javascript" src="${path}/js/jquery.mockjax.js"></script>
<script>
    $(function () {
        $("#submit").click(function () {
            ...
            $.ajax({
                ...
                url: "/login",//url
                data: {"username": username, "password": password},// 要提交的表单
...
<script type="text/javascript" src="${path}/img/ThreeWebGL.js"></script>
<script type="text/javascript" src="${path}/img/ThreeExtras.js"></script>
<script type="text/javascript" src="${path}/img/Detector.js"></script>
<script type="text/javascript" src="${path}/img/RequestAnimationFrame.js"></script>
